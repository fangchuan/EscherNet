...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--train_split_file",
        type=str,
        default="/mnt/nas_3dv/hdd1/datasets/KoolAI/processed_data_20240413/train.txt",
        help="The path to the split file for the training dataset.",
    )
...
def main(args):
    ...
    train_dataset = KoolAIPanoData(root_dir=args.train_data_dir,
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                noisy_latents = noise_scheduler.add_noise(gt_latents.to(dtype=torch.float32), 
                                                          ...
                                                          timesteps).to(dtype=gt_latents.dtype)
                ...
                if do_classifier_free_guidance:  #support classifier-free guidance, randomly drop out 5%
                    ...
                    img_prompt_embeds = _encode_image(feature_extractor, image_encoder, input_image, False)
                    ...
                    prompt_embeds = _encode_image(feature_extractor, image_encoder, input_image, False)
